...
|---|---|---|---|
| 1 — `signal()` | `src/app/features/clients/pages/clients/clients.component.ts` | Valeur reactive mutable lue avec `()`. | Convertir l'etat `adding` en signal. Le template doit afficher le formulaire a partir du signal et les tests doivent verifier ce nouvel etat reactif. |
